...
- **UTMStack** — #6 contributor, 171 commits across Go SIEM/XDR/SOAR. [Contributor graph](https://github.com/utmstack/UTMStack/graphs/contributors).
- **threatwinds/go-sdk** — authored CEL functions consumed by 22 Go modules in production. [Repo](https://github.com/threatwinds/go-sdk).
- **GitDocAI** — building the MVP: Go backend + React/Angular. Clients: UTMStack, InsecureWeb, ThreatWinds.
- **Gentleman-Programming/gentle-ai** — merged [PR #161](https://github.com/Gentleman-Programming/gentle-ai/pull/161) (feat(kilocode)).
...
Ciego de Ávila, Cuba · Remote · Spanish (native), English (working / conversational).
